// Разделить контроллер на несколько файлов? Для читаемости. Разбить на Partial позже, когда буду рефакторить.
// Перейти на Razor Pages?
// Зачем 3 контекста и 3 таблицы в бд под файлы если можно использовать 1? Разделение на подсистемы: Акаунты авторов, акаунты клиентов, и данные курсов.
// Добавить коментариев параша не читаема
